...
fs.writeFileSync(__dirname + '/../expected/PAPER4_34_PATTERN_TO_19_FAMILY_TABLE_2026-08-29.csv', csv.join('\n') + '\n');
...
fs.writeFileSync(__dirname + '/../runs/sixdomain_full.json', JSON.stringify({ byL, cardFailures: cardFail,
