...
| 2 | **`MATH_CLAIMS.md`** | **The sole authority for every mathematical claim.** 119 rows. No claim may appear anywhere without a row here |
...
```bash
node tests/test.js                 # 42/42
node scripts/check-claims-drift.js # 18/18
```
