...
The project source, proof-replay material, and computational validation artifacts are maintained at `https://github.com/word-structures/combinatorics-on-words-research`. This document is the first complete typeset preprint version (v1.0, 29 August 2026).
