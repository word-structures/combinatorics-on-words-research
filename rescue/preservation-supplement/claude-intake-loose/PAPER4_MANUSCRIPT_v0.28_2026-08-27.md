...
**Working manuscript v0.28 — 2026-08-27**
...
second full population implementation.  The latest 3403-word D-active basin
closes completely as
\[
3403F\to77F^+\to325AF\to0ABDEF,
\]
with all 325 AF pairs independently clean-room checked and all initially
capped extension cases rerun to exact zero-cap termination.
...
The exact set intersection with the previous union is zero, and the canonical
union check gives
...
Thus 29712 is recorded as an exact lower bound, but not yet as a
