...
At minimum the actual macro language requires
\[
AC,\quad BC,\quad CB,\quad CBC,
\]
and any implementation may impose an exactly proved stronger equivalent
local package such as the cyclic-80 BC test used in the current code, provided
its soundness is recorded.
