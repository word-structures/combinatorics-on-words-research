...
**Working manuscript v0.33 — 2026-08-29**  
...
263/263
\]
quota-matched canonical H pairs for the **joint** predicate `AF_AND_AFE_EXISTS` (44 positive). The `AFE_EXISTS` column reported above has not yet received an equivalent two-solver cross-check.
...
1. the `263/263` two-solver agreement is attached only to the joint `AF_AND_AFE_EXISTS` predicate it actually validates;
