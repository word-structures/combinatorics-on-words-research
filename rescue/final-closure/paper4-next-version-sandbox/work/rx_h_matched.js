...
const evaluated = new Set(JSON.parse(fs.readFileSync('../runs/distinctA_H.json', 'utf8')));
const pairsH = jl('../runs/bcdBIG_H/pairs.jsonl');
...
P.writeAtomic('../runs/h_matched_quota.json', { quota: Q, summary, strata, perE });
