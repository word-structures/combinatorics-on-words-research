...
fs.writeFileSync(`${OUT_DIR}/ALL_GRAPH_DOMINANCE_FINAL_AUDIT.json`, JSON.stringify(scc_audit, null, 2));
fs.writeFileSync(`${OUT_DIR}/PERIOD_FINAL_AUDIT.json`, JSON.stringify(period_audit, null, 2));
fs.writeFileSync(`${OUT_DIR}/Q_PARTITION_FINAL_AUDIT.json`, JSON.stringify(q_partition_audit, null, 2));
fs.writeFileSync(`${OUT_DIR}/QV_INDEPENDENT_AUDIT.json`, JSON.stringify(qv_independent_audit, null, 2));
fs.writeFileSync(`${OUT_DIR}/VARIANCE_AB_FINAL_AUDIT.json`, JSON.stringify({A: variance_method_A_audit, B: variance_method_B_audit}, null, 2));
fs.writeFileSync(`${OUT_DIR}/PRESSURE_CURVATURE_FINAL_AUDIT.json`, JSON.stringify(spotcheck_C, null, 2));
fs.writeFileSync(`${OUT_DIR}/PROFILE_BASELINE_RUN3C_RECOVERED.json`, JSON.stringify(profile_baseline_arr, null, 2));
...
fs.writeFileSync(`${OUT_DIR}/H5_311_FINAL_SPECTRAL_CERTIFICATE.json`, JSON.stringify(h5_311_audit, null, 2));
fs.writeFileSync(`${OUT_DIR}/PRESENTATION_INVARIANCE_FINAL_AUDIT.json`, JSON.stringify(invar, null, 2));
