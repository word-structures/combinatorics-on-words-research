...
**Working manuscript v0.24 — 2026-08-27**
...
\]
Together with 24 additional fixed-F exclusions outside these eight components,
at least
\[
\boxed{3064}
\]
distinct length-40 F-role blocks are globally excluded as \(H(f)\).
...
one-command H40 certifier now composes the profile/kernel gate, exact
22-trigram period-\(2,\ldots,40\) gate and Gate T.  The complete six-block
coding remains open.
