...
if __name__=='__main__':
 ...
 out={'profile':[4,3,1],'m':44,'round_pad':2e-10,'part':part,'parts':parts,'interval_count_total':len(intervals),'interval_count_part':len(chunk),'records':rec,'min_alphaP':min(z['alphaP_lower'] for z in rec),'seconds':time.time()-t0}
