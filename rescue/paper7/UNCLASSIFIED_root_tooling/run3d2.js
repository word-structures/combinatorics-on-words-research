...
fs.writeFileSync(dir + '/DIRECT_WORD_ENUMERATOR.json', JSON.stringify(directProfiles, null, 2));
...
fs.writeFileSync(dir + '/GRAPH_EDGE_ENUMERATOR.json', JSON.stringify(graphProfiles, null, 2));
...
fs.writeFileSync(dir + '/RUN3C_ACTUAL_PROFILE_ROWS_AUDIT.json', JSON.stringify(actualRows, null, 2));
