...
# 4. Finite base window. For crossing squares with K<85, start i<11 gives end<179.
...
print('base window:',BASE,'letters — ASF and residual-free')
print('W1:',len(W1),'ASF')
print('W2:',len(W2),'no crossing square (interior protected by Keranen endomorphism)')
print('THEOREM LOGIC CERTIFIED SUBJECT TO THE CLASSICAL INPUT: G85 maps every ASF word to an ASF word.')
