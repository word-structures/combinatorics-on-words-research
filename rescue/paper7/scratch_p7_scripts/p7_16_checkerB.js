...
console.log(`[Checker B] Verifying base cases K <= ${K_0} for ad*X`);
let counterExamples = 0;

for (let K = 1; K <= K_0; K++) {
    // U starts at 0, length K
    // V starts at K, length K
    let P_U = [0,0,0,0];
    let P_V = [0,0,0,0];
...
console.log(`[Checker B] Complete. Counterexamples: ${counterExamples}`);
